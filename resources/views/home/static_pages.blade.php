...
<main role="main" id="site-content" <?php if($current_url!=$become_host){ ?> class="margin-top-120" <?php } ?>>
    <div <?php if($current_url!=$become_host){ ?> class="container-fluid container-fluid-90 " <?php } ?>>
        {!! $content !!}
    </div>
    <br>
       ...
       <div class="card-body card-user">
            <form method="POST" action="{{ route('addContact') }}" enctype="multipart/form-data">
             ...
             <div class="row mt-5">
                 ...
                 <div class="col-md-10">
                      <textarea class="form-control textarea contact-textarea" placeholder="Message" name="message" required></textarea>
                 </div>
             </div>
