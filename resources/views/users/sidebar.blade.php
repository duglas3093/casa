		...
		<div class="">
			<ul class="list-group-flush pl-3">
				...
				<a class="text-color" href="{{ url('users/profile') }}">
					<li class="vbg-default-hover pl-20  border-0 text-15 p-2 {{ (request()->is('users/profile') || request()->is('users/profile/media') || request()->is('users/edit-verification') || request()->is('users/security')) ? 'active-sidebar' : '' }}">
				...
				<a class="text-color" href="{{ url('users/payout-list') }}">
					<li class="vbg-default-hover pl-20  border-0 text-15 p-2 {{ (request()->is('users/payout-list' ) || request()->is('users/payout')) ? 'active-sidebar' : '' }}">
