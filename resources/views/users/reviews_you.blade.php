                    ...
                    <div class="main-panel">
                        <div class="row justify-content-center">
                            <div class="col-md-12 p-0">
                                <ul class="nav  navbar-expand-lg navbar-light border rounded-3 p-2 pt-4 pb-4" role="tablist">
                                    <li class="nav-item">
                                                        ...
                                                        <div class="col-md-12 p-0">
                                                            <div class="d-flex justify-content-between">
                                                                <div>
                                                                    ...
                                                                    <a href="{{ url('/') }}/reviews/edit/{{ $writeReview->id }}" class="text-color text-color-hover font-weight-700 text-15 text-success">{{ trans('messages.reviews.write_review') }}</a>
                                                                </div>
