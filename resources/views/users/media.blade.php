                        ...
                        <div class="row mt-5 border pt-4 pb-4 rounded">
                            <div class="col-md-3">
                                @if($result->profile_image)
                                    <img width="190" height="190" title="{{ Auth::user()->first_name }}" src="{{  url('public/images/profile').'/'.Auth::user()->id.'/'.$result->profile_image }}" alt="{{ $result->first_name }}">
                                    @else
                                    <img width="190" height="190" title="{{ Auth::user()->first_name }}" src="{{  \Auth::user()->profile_src }}" alt="{{ $result->first_name }}">
                                    @endif
