        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Account checklist</h3>
...
$(function() {
      ...
      $(document).on("click", "#csv", function(event){
        ...
        window.location = "payouts_confirm_list_csv?to="+to+"&from="+from+"&space_type="+space_type+"&status="+status;
      });
      //pdf convert
      $(document).on("click", "#pdf", function(event){
        ...
        var to = $('#endDate').val();
        var from = $('#startDate').val();
        window.location = "admin/payouts/payouts_list_pdf?to="+to+"&from="+from+"&space_type="+space_type+"&status="+status;
      });
      //reload Datatable
