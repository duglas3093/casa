				...
				<div class="col-xs-12">
					<div class="box">
						<div class="box-header">
							...
							<div class="pull-right"><a class="btn btn-primary" href="{{ url('admin/add-customer') }}">Add Customer</a></div>
							@endif
						</div>
					
						<div class="box-body">
							<div class="table-responsive">
								{!! $dataTable->table(['class' => 'table table-hover dt-responsive', 'width' => '100%', 'cellspacing' => '0']) !!}
							</div>
						</div>
					</div>
				</div>
