      ...
      <div class="col-md-12">
        ...
        <div class="box">
          ...
          <div class="box-header with-border">
            <h3 class="box-title">Edit Property Form</h3>
          </div>
          <!-- form start -->
		  
          <form class="form-horizontal" action="{{url('admin/settings/edit-property-type/'.$result->id)}}" id="edit_property" method="post" name="edit_property" accept-charset='UTF-8' {{-- onsubmit="return contentValidate();" --}}>
            {{ csrf_field() }}
            ...
            <div class="box-body">
             ...
             <div class="form-group">
               ...
               <div class="col-sm-6">
                 <textarea id="description" name="en[description]" rows="10" cols="50" class="form-control" required>{{$result->description}}</textarea>
			 ...
			 <div class="box-group" id="accordion">
				...
				<?php 
					$query = App\Models\PropertyType::where([ ['temp_id',$result->id],['lang_id', $language->id ]])->first();
				?>
