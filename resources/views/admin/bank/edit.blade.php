        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <form class="form-horizontal" action="{{url('admin/edit-bank')}}/{{$bank->id}}" id="edit_bank" method="post" name="signup_form" accept-charset='UTF-8'>
                        <h4 class="text-info text-center">Update Bank Information</h4>
                        {{ csrf_field() }}
