	...
	<ul class="sidebar-menu">
		...
		<li class="treeview {{ (Route::current()->uri() == 'admin/settings/property-type' || Route::current()->uri() == 'admin/settings/space-type' || Route::current()->uri() == 'admin/settings/bed-type') ? 'active' : ''  }}">
			...
			<li class="treeview {{ (Route::current()->uri() == 'admin/sales-report' || Route::current()->uri() == 'admin/sales-analysis' || Route::current()->uri() == 'admin/overview-stats') ? 'active' : ''  }}">
				...
				<ul class="treeview-menu">
				<li class="{{ (Route::current()->uri() == 'admin/overview-stats') ? 'active' : ''  }}"><a href="{{ url('admin/overview-stats') }}"><span>Overview</span></a></li>
				<li class="{{ (Route::current()->uri() == 'admin/sales-report') ? 'active' : ''  }}"><a href="{{ url('admin/sales-report') }}"><span>Booking Report</span></a></li>
				<li class="{{ (Route::current()->uri() == 'admin/sales-analysis') ? 'active' : ''  }}"><a href="{{ url('admin/sales-analysis') }}"><span>Data Analysis</span></a></li>
				</ul>
			</li>
		@endif
