				...
				<div class="col-md-12 p-0">
					<div class="main-panel">
						<div class="row justify-content-center">
							...
							<div class="col-md-6 mt-4 mt-sm-0 pl-5 mob-pd-lft">
								<form id="img_form" enctype='multipart/form-data' method="post" action="{{url('listing/'.$result->id.'/'.$step)}}" accept-charset='UTF-8'>
									...
									<div class="row">
                                    	<div class="col-md-12 border mt-4 pb-5 rounded-3 pl-sm-0 pr-sm-0 mob-pd-0">
                                    		<div class="row">
                                    			<div class="form-group col-md-12 main-panelbg pb-3 pt-3 mt-sm-0 ">
                                    				<h4 class="text-18 font-weight-700 pl-3">Videos</h4>
                                    			</div>
									...
									<div class="col-md-12 p-0 mt-4 mb-5">
										<div class="row m-0 justify-content-between">
											...
											<div class="mt-4">
												...
												<a href="{{url('listing/'.$result->id.'/pricing')}}" class="btn vbtn-default text-16 font-weight-700 pl-5 pr-5 pt-3 pb-3 pl-5 pr-5" id="btnnext"><i class="spinner fa fa-spinner fa-spin d-none" id="btn_spin"></i>
...
//     		        myId = getId(url);
//     		        //$('#iframe_id').src(myId);
//     		        var full_link = "https://www.youtube.com/embed/"+myId;
//     		        $('#iframe_id').attr('src', full_link);
