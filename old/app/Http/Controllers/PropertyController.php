...
class PropertyController extends Controller
{
    ...
    public function listing(Request $request, CalendarController $calendar)
    {
        ...
        if ($step == 'basics') {
            ...
            $data['bed_type']       = BedType::where('lang', $current_lang)->pluck('name', 'id');
            $data['property_type']  = PropertyType::where('status', 'Active')->where('lang', $current_lang)->pluck('name', 'id');;
            $data['space_type']     = SpaceType::where('lang', $current_lang)->pluck('name', 'id');
            ...
            $data['amenities_type']     = AmenityType::where('lang', $current_lang)->get();
        } elseif ($step == 'photos') {
            if ($_FILES) {
