...
<div class="container">
   ...
   <div class="row mt-4 mt-sm-0">
      <div class="col-lg-8 col-xl-8 col-sm-12 p-0">
         <div class="row  pb-5"  id="listMargin">
                  ...
                  <div class="col-md-12 col-sm-12 p-0">
                     <div class="row">
                        <div class="col-md-6 col-sm-6 p-0">
                           ...
                           <div class="text-15"><span  class="">{{trans('messages.property_single.bed_type')}}:</span> @if(empty($other_lang_bed)) {{ @$result->bed_types->name }} @else {{ $other_lang_bed }} @endif</div>
                           @endif
