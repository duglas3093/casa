        ...
        <div class="col-md-9">
          ...
          <form id="img_form" enctype='multipart/form-data' method="post" action="{{url('admin/listing/'.$result->id.'/'.$step)}}" class='signup-form login-form' accept-charset='UTF-8'>
            ...
            <div class="">
              ...
              <div class="col-md-6">
                ...
                <p class="text-13" style="margin-top:10px;">( Width:640px and Height:360px )</p>
                @if ($errors->any())     
          ...
          <div class="col-md-12">
            <div class="col-md-10 col-sm-6 col-xs-6 l-pad-none text-left">
                <a data-prevent-default="" href="{{ url('admin/listing/'.$result->id.'/amenities') }}" class="btn btn-large btn-default">{{trans('messages.listing_description.back')}}</a>
            </div>
