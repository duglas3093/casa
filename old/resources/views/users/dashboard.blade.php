...
<div class="margin-top-85">
	<div class="row m-0">
		...
		<div class="col-lg-9">
			<div class="p-5 db-content">
			    <h2 class="font-weight-700 text-color text-30">{{trans('messages.users_dashboard.welcome_to')}} <span class="text-capitalize">{{ $result->first_name }}</span></h2>
                ...
                <div class="row  ">
							<div class="col-md-12 mt-4 p-0">
									...
									<div>
                                        ...
                                        {{trans('messages.header.lives_in')}} {{ $details['live'] }}, <span class="text-capitalize">{{ $result->default_country }}</span>
                                        </p>
									</div>
								    @endif
				...
				<!--<div class="row mt-4">
					...
					<div class="col-md-4">
						<div class="p-5 mt-3 small-box d-flex border">
					...
					<div class="col-md-4">
						<div class="p-5 mt-3 small-box border d-flex">
					...
					<div class="col-md-4">
						<div class="small-box p-5 mt-3 border d-flex">
