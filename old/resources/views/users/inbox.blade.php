										...
										<div class="col-md-12 p-0">
											<div class="full-table mt-2 border text-dark rounded-3 pt-3 pb-3 mb-4 p-4">
												<p class="row margin-top10 text-justify text-16 mb-0">
													...
													<span class="text-right col-sm-6 col-6 text-14">${{$booking->per_night * $booking->total_night}}</span>
												</p>

												<p class="row margin-top10 text-justify text-16 mb-0">
													<span class="text-left col-sm-6 col-6 text-14">{{trans('messages.property_single.service_fee')}}</span>
													<span class="text-right col-sm-6 col-6 text-14">${{$booking->service_charge}}</span>
												</p>

												@if($booking->accomodation_tax)
												<p class="row margin-top10 text-justify text-16 mb-0">
													<span class="text-left col-sm-6 col-6 text-14">{{trans('messages.property_single.accommodatiton_tax')}}</span>
													<span class="text-right col-sm-6 col-6 text-14">${{$booking->accomodation_tax}}</span>
												</p>
												@endif
												...
												<p class="row margin-top10 text-justify text-16 mb-0">
													...
													<span class="text-right col-sm-6 col-6 text-14">${{$booking->iva_tax}}</span>
												</p>
												@endif
												...
												<p class="row mt-3 text-justify text-16 mb-0">
													...
													<span class="text-right col-sm-6 col-6 text-16 font-weight-600">${{$booking->total}}</span>
												</p>
											</div>	
										</div>
									</div>
