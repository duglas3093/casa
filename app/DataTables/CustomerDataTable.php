    ...
    public function ajax()
    {
        return datatables()
            ...
            ->addColumn('action', function ($users) {
                ...
                $edit = \Helpers::has_permission(Auth::guard('admin')->user()->id, 'edit_customer') ?'<a href="' . url('admin/edit-customer/' . $users->id) . '" class="btn btn-sm svbtn"><i class="fa fa-pencil"></i></a>&nbsp;' : '';
