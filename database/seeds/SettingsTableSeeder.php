...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('settings')->insert([
        	['name' => 'name', 'value' => 'buyrental', 'type' => 'general'],
            ...
            ['name' => 'username', 'value' => 'migrateshop_business_api1.gmail.com', 'type' => 'PayPal'],
            ...
            ['name' => 'host', 'value' => 'mail.migrateshop.com', 'type' => 'email'],
            ['name' => 'port', 'value' => '587', 'type' => 'email'],
            ['name' => 'from_address', 'value' => 'stockpile@migrateshop.com', 'type' => 'email'],
            ['name' => 'from_name', 'value' => 'buyrental', 'type' => 'email'],
            ['name' => 'encryption', 'value' => 'tls', 'type' => 'email'],
            ['name' => 'username', 'value' => 'stockpile@migrateshop.com', 'type' => 'email'],
