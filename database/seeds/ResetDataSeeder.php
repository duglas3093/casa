...
class ResetDataSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('admin')->insert(['username' => 'admin', 'email' => 'admin@migrateshop.com', 'password' => Hash::make('123456'), 'status' => 'Active', 'created_at' => date('Y-m-d H:i:s')] );
        ...
        User::insert( ['first_name' => 'test', 'last_name' => 'user', 'email' => 'test@migrateshop.com', 'profile_image' => 'profile.png', 'password' => Hash::make('123456'), 'status' => 'Active', 'created_at' => date('Y-m-d H:i:s')] );   

        User::insert( ['first_name' => 'customer', 'last_name' => 'user', 'email' => 'customer@migrateshop.com', 'profile_image' => 'profile.jpg', 'password' => Hash::make('123456'), 'status' => 'Active', 'created_at' => date('Y-m-d H:i:s')] );
